// axi-sdk-js managed opencode plugin: fastmail-axi
import { spawn } from "node:child_process";

const command = "fastmail-axi";
const marker = "fastmail-axi";
const ambientHeader = "## AXI ambient context: fastmail-axi";
...
export const AxiFastmailAxiAmbientContextPlugin = async ({ directory }) => {
