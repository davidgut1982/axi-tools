// axi-sdk-js managed opencode plugin: vector-indexer-axi
import { spawn } from "node:child_process";

const command = "vector-indexer-axi";
const marker = "vector-indexer-axi";
const ambientHeader = "## AXI ambient context: vector-indexer-axi";
...
export const AxiVectorIndexerAxiAmbientContextPlugin = async ({ directory }) => {
