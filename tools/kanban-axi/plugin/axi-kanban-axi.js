// axi-sdk-js managed opencode plugin: kanban-axi
import { spawn } from "node:child_process";

const command = "kanban-axi";
const marker = "kanban-axi";
const ambientHeader = "## AXI ambient context: kanban-axi";
...
export const AxiKanbanAxiAmbientContextPlugin = async ({ directory }) => {
