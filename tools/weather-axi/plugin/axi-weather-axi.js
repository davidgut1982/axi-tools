// axi-sdk-js managed opencode plugin: weather-axi
import { spawn } from "node:child_process";

const command = "weather-axi";
const marker = "weather-axi";
const ambientHeader = "## AXI ambient context: weather-axi";
...
export const AxiWeatherAxiAmbientContextPlugin = async ({ directory }) => {
