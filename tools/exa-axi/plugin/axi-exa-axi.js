// axi-sdk-js managed opencode plugin: exa-axi
import { spawn } from "node:child_process";

const command = "exa-axi";
const marker = "exa-axi";
const ambientHeader = "## AXI ambient context: exa-axi";
...
export const AxiExaAxiAmbientContextPlugin = async ({ directory }) => {
