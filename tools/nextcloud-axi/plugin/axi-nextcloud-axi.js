// axi-sdk-js managed opencode plugin: nextcloud-axi
import { spawn } from "node:child_process";

const command = "nextcloud-axi";
const marker = "nextcloud-axi";
const ambientHeader = "## AXI ambient context: nextcloud-axi";
...
export const AxiNextcloudAxiAmbientContextPlugin = async ({ directory }) => {
