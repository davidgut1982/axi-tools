// axi-sdk-js managed opencode plugin: tavily-axi
import { spawn } from "node:child_process";

const command = "tavily-axi";
const marker = "tavily-axi";
const ambientHeader = "## AXI ambient context: tavily-axi";
...
export const AxiTavilyAxiAmbientContextPlugin = async ({ directory }) => {
