// axi-sdk-js managed opencode plugin: npm-axi
// This file is generated by axi-sdk-js. It is safe to edit only if you remove the managed marker above.
import { spawn } from "node:child_process";

const command = "npm-axi";
const marker = "npm-axi";
const ambientHeader = "## AXI ambient context: npm-axi";
...
export const AxiNpmAxiAmbientContextPlugin = async ({ directory }) => {
