// axi-sdk-js managed opencode plugin: workspace-axi
import { spawn } from "node:child_process";

const command = "workspace-axi";
const marker = "workspace-axi";
const ambientHeader = "## AXI ambient context: workspace-axi";
...
export const AxiWorkspaceAxiAmbientContextPlugin = async ({ directory }) => {
