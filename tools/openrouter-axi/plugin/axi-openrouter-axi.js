// axi-sdk-js managed opencode plugin: openrouter-axi
import { spawn } from "node:child_process";

const command = "openrouter-axi";
const marker = "openrouter-axi";
const ambientHeader = "## AXI ambient context: openrouter-axi";
...
export const AxiOpenrouterAxiAmbientContextPlugin = async ({ directory }) => {
