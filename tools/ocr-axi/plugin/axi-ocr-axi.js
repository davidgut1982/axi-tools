// axi-sdk-js managed opencode plugin: ocr-axi
import { spawn } from "node:child_process";

const command = "ocr-axi";
const marker = "ocr-axi";
const ambientHeader = "## AXI ambient context: ocr-axi";
...
export const AxiOcrAxiAmbientContextPlugin = async ({ directory }) => {
