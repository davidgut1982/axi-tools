// axi-sdk-js managed opencode plugin: lore-axi
// This file is generated by axi-sdk-js. It is safe to edit only if you remove the managed marker above.
import { spawn } from "node:child_process";

const command = "lore-axi";
const marker = "lore-axi";
const ambientHeader = "## AXI ambient context: lore-axi";
...
export const AxiLoreAxiAmbientContextPlugin = async ({ directory }) => {
