// axi-sdk-js managed opencode plugin: langfuse-axi
import { spawn } from "node:child_process";

const command = "langfuse-axi";
const marker = "langfuse-axi";
const ambientHeader = "## AXI ambient context: langfuse-axi";
...
export const AxiLangfuseAxiAmbientContextPlugin = async ({ directory }) => {
